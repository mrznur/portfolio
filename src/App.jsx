        ...
        return (
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-slate-200 bg-gradient-to-br from-[#b3cde0]/30 to-transparent p-4 rounded-lg">
              <p className="text-sm font-semibold text-[#011f4b] mb-3">Quick Info</p>
              <div className="space-y-2 text-sm text-[#03396c]">
                <p className="flex items-center gap-2">
                  <span className="text-[#005b96]">Location: </span> {person.location}
                </p>
                <p className="flex items-center gap-2">
            ...
            {projects.map((p) => (
              <div key={p.title} className="border-b border-slate-200 last:border-0 pb-6 last:pb-0">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {p.stack.map((tech) => (
                    <span key={tech} className="text-xs px-3 py-1 bg-[#b3cde0] text-[#011f4b] rounded-full font-medium">
                      {tech}
                    </span>
                  ))}
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 mt-3 text-sm text-[#005b96] hover:text-[#03396c] font-medium transition"
                >
                  View Repository
      ...
      case "contact":
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#b3cde0]/30 to-transparent p-4 rounded-lg">
              <p className="text-sm font-semibold text-[#011f4b] mb-3">Social Links</p>
        ...
        <Section id="what-i-do" title="Skills">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {[...skills.frontend, ...skills.database, ...skills.tools].map((x) => (
                  <Tag key={x}>{x}</Tag>
                ))}
              </div>
            </Card>
        ...
        <Section id="contact" title="Contact">
          <Card>
            <p className="">
              ...
              <a className="text-blue-900 hover:underline text-sm" href={`mailto:${person.email}`}>
                {person.email}
              </a>
            </p>
          </Card>
